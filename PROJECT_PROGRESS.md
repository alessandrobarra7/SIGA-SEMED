...
| Testes mais recentes | 98 testes automatizados aprovados, além de checagem TypeScript e build de produção. |
| Identidade visual | Login ilustrado com marca municipal fornecida, tipografia humanizada e painel de acesso claro — congelado por aprovação expressa. Montserrat ExtraBold atende títulos, chamadas e números de destaque. Após validação de fonte calculada e nova captura do usuário, as legendas e controles internos de Início usam Manrope com escala reforçada, peso 700, maior contraste e espaçamento para produzir hierarquia perceptível na resolução de uso. Inter permanece como fonte de corpo e interface nos demais usos internos. Marcadores decorativos e caixa alta compulsória foram removidos de cartões, agenda e ações rápidas; caixa alta permanece apenas em estados e cabeçalhos de tabela. |
