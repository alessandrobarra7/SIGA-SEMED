...
const viewPermissionKey: Partial<Record<ShellView, SemedModuleKey>> = {
  ...
  schools: "unidades_escolares", "schools-reports": "unidades_escolares", educa: "educa_paco", "educa-reports": "educa_paco", people: "rh", nutrition: "nutricao", "nutrition-weekly": "nutricao.planejamento_semanal", "nutrition-annual": "nutricao.planejamento_anual", stock: "estoque", "stock-family": "estoque.agricultura_familiar", "stock-industrial": "estoque.industrializado", "stock-kit": "estoque.kit_aluno", "stock-food": "estoque.categorias", "stock-cleaning": "estoque.categorias", "stock-office": "estoque.categorias", "stock-reports": "estoque.relatorios", fleet: "frota", users: "usuarios",
};
...
function ModulePlaceholder({ view, onHome }: { view: ShellView; onHome: () => void }) {
  if (view.startsWith("stock-") || view === "finance") return null;
