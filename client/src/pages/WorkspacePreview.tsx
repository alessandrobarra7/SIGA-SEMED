...
{activeView === "records" || activeView === "documents" ? localContent : null}
      {!["welcome", "home", "governance", "masters", "people", "users", "nutrition-weekly", "nutrition-annual", "records", "documents"].includes(activeView) ? <ModulePlaceholder view={activeView} onHome={() => changeView("home")} /> : null}
